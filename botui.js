    ...
    var sure = function() {
        ...
        secondpart = function() {
            botui.message.add({
                ...
                botui.message.add({
                    delay: 1500,
                    content: "向往技术于是选择了计算机专业…"
                }).then(function() {
                    botui.message.add({
                        delay: 1200,
                        content: "因为小时候就感觉会计算机技术就很了不起嘛"
                    }).then(function() {
                        botui.message.add({
                            delay: 1500,
                            content: "主攻 Java 语言，略懂 Python 和 C++，偶尔也折腾 HTML/CSS/JavaScript/PHP"
                        }).then(function() {
                            botui.message.add({
                                delay: 1500,
                                content: "研究的方向，是密码学和网络攻防等……"
                            }).then(function() {
                                botui.message.add({
                                    delay: 1800,
                                    content: "喜欢看动漫，玩游戏，可以加我steam好友哦，嘿嘿……"
                                }).then(function() {
                                    botui.action.button({
                                        delay: 1100,
                                        action: [{
        ...
        thirdpart = function() {
            botui.message.add({
                delay: 1E3,
                content: "Jerry来自于猫和老鼠(Tom and Jerry)是小时候爸爸妈妈给买的第一部动漫光盘，最喜欢这部动漫了！"
            }).then(function() {
                botui.action.button({
                    delay: 1500,
                    action: [{
        ...
        fifthpart = function() {
            botui.message.add({
                delay: 1E3,
                content: "emmmm，因为域名有一个特殊的含义=.= 如果你喜欢解密的话可以猜一下😉"
            }).then(function() {
                botui.message.add({
                    delay: 1600,
